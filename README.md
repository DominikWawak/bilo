...
![Editor demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/editor.gif)

### Slash commands

Type `/` anywhere in a note to open the command menu.

![Slash menu demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/slash-menu.gif)
...
![Sidebar demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/sidebar.gif)
...
![Calendar demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/calendar.gif)
...
![Search demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/search.gif)

### Rich blocks

Todo lists and tables via slash commands.

![Blocks demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/blocks.gif)

### Settings

Full-page settings (⚙ in sidebar footer). Searchable sections for AI, Jira, GitHub sync, and import.

![Settings demo](https://github.com/DominikWawak/bilo/raw/main/docs/gifs/settings.gif)
